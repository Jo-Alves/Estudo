        ...
        public static void Print(this LocalReport report, PageSettings pageSettings)
        {
            string deviceInfo =
                $@"<DeviceInfo>
                    ...
                    <MarginTop>{pageSettings.Margins.Top * 20}in</MarginTop>
                    <MarginLeft>{pageSettings.Margins.Left * 20}in</MarginLeft>
                    <MarginRight>{pageSettings.Margins.Right * 20}in</MarginRight>
                    <MarginBottom>{pageSettings.Margins.Bottom * 20}in</MarginBottom>
                </DeviceInfo>";
            Warning[] warnings;
